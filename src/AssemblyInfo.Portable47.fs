...
[<assembly: AssemblyVersionAttribute("2.3.3.47")>]
[<assembly: AssemblyFileVersionAttribute("2.3.3.47")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "2.3.3.47"
    let [<Literal>] InformationalVersion = "2.3.3.47"

...
type public CsvProvider(cfg:TypeProviderConfig) as this =
  ...
  let parameters = 
    [ ProvidedStaticParameter("Sample", typeof<string>, parameterDefaultValue = "") 
      ...
      ProvidedStaticParameter("FixedWidth", typeof<bool>, parameterDefaultValue = false)]
  ...
  let helpText = 
    """<summary>Typed representation of a CSV file.</summary>
       ...
       <param name='FixedWidth'>When set to true the file is considered a fixed width file.</param>"""

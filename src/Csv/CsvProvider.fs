...
type public CsvProvider(cfg:TypeProviderConfig) as this =
  ...
  let buildTypes (typeName:string) (args:obj[]) =
    ...
    generateType "CSV" sample (*sampleIsList*)false inlineSample parse (fun _ _ -> failwith "Not Applicable")
  ...
  let parameters = 
    [ ProvidedStaticParameter("Sample", typeof<string>, parameterDefaultValue = "") 
      ...
      ProvidedStaticParameter("InlineSample", typeof<bool>, parameterDefaultValue = false) ]
  ...
  let helpText = 
    """<summary>Typed representation of a CSV file.</summary>
       ...
       <param name='InlineSample'>Implicitly instruct TypeProvider that Sample is inline, not file path nor url. Defaults to false.</param>"""

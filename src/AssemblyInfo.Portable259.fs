...
[<assembly: AssemblyVersionAttribute("2.3.0.259")>]
[<assembly: AssemblyFileVersionAttribute("2.3.0.259")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "2.3.0.259"
    let [<Literal>] InformationalVersion = "2.3.0.259"

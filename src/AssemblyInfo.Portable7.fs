...
[<assembly: AssemblyVersionAttribute("2.3.3.7")>]
[<assembly: AssemblyFileVersionAttribute("2.3.3.7")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "2.3.3.7"
    let [<Literal>] InformationalVersion = "2.3.3.7"

...
[<assembly: AssemblyVersionAttribute("2.4.6.7")>]
[<assembly: AssemblyFileVersionAttribute("2.4.6.7")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.4.6.7"
    let [<Literal>] AssemblyFileVersion = "2.4.6.7"

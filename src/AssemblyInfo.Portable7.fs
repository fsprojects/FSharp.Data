...
[<assembly: AssemblyVersionAttribute("2.3.2.7")>]
[<assembly: AssemblyFileVersionAttribute("2.3.2.7")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] Version = "2.3.2.7"
    let [<Literal>] InformationalVersion = "2.3.2.7"

    ...
    for (name,t) 
      ...
      do
         let p = InferedType.Record(Some "", [{Name ="";
                                               Optional = false;
                                               Type = InferedType.Primitive(t,None)}])
               ...
               match typeDeclaration with
                 ...
                 | :? simpleType as simple -> 
                      ...
                      let t = 
                          ...
                          | InferedType.Record(Some _,[{Name = "";Optional = _;Type = t}]) -> t
                 ...
                 | :? complexType as typeDeclaration -> 
                      ...
                      let attributes = 
                            ...
                            |> List.map (fun a -> 
                                 ...
                                 {Name = a.Name;
                                  Optional = (a.Use = XmlSchemaUse.Optional);
                                  Type = t})
                      ...
                      InferedType.Record(
                          Some n,
                            {Name = "";
                              Optional = false;
                              Type = InferedType.Collection(elements |> Map.ofList)}::attributes)

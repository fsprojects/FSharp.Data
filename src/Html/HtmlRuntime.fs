...
type HtmlDocument internal (doc, tables, lists, definitionLists) =
    ...
    [<CompilerMessageAttribute("This method is intended for use in generated code only.",
                               ...
                               IsHidden = true,
                               IsError = false)>]
    member __.GetTable(id: string) = tables |> Map.find id
    ...
    [<CompilerMessageAttribute("This method is intended for use in generated code only.",
                               ...
                               IsHidden = true,
                               IsError = false)>]
    member __.GetList(id: string) = lists |> Map.find id
    ...
    [<CompilerMessageAttribute("This method is intended for use in generated code only.",
                               ...
                               IsHidden = true,
                               IsError = false)>]
    member __.GetDefinitionList(id: string) = definitionLists |> Map.find id

...
type public HtmlProvider(cfg:TypeProviderConfig) as this =
    ...
    let buildTypes (typeName:string) (args:obj[]) =
        ...
        generateType "HTML" sample (*sampleIsList*)false inlineSample (fun _ -> HtmlDocument.Parse) (fun _ _ -> failwith "Not Applicable")
    ...
    let helpText = 
        """<summary>Typed representation of an HTML file.</summary>
           ...
           <param name='InlineSample'>Implicitly instruct TypeProvider, that Sample is inline sample, not file path or url. Defaults to false.</param>"""

...
module internal Debug = 
    ...
    let generate (resolutionFolder: string) (runtimeAssembly: string) (runtimeAssemblyRefs: string list) typeProviderForNamespacesConstructor args =
        ...
        Diagnostics.Debug.Assert(cfg.GetType().GetField("systemRuntimeContainsType") <> null)
        Diagnostics.Debug.Assert(systemRuntimeContainsType.GetType().GetField("tcImports") <> null)
        Diagnostics.Debug.Assert(typeof<TcImports>.GetField("dllInfos") <> null)
        Diagnostics.Debug.Assert(typeof<TcImports>.GetProperty("Base") <> null)
        Diagnostics.Debug.Assert(typeof<DllInfo>.GetProperty("FileName") <> null)

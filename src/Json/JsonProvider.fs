...
type public JsonProvider(cfg:TypeProviderConfig) as this =
    ...
    let buildTypes (typeName:string) (args:obj[]) =
        ...
        let inferDictionariesFromRecords = args.[8] :?> bool
        ...
        let getSpec _ value = 
            ...
            using (IO.logTime "TypeGeneration" sample) <| fun _ ->
                ...
                let ctx = JsonGenerationContext.Create(cultureStr, tpType, ?inferDictionariesFromRecords = Some inferDictionariesFromRecords)
    ...
    let parameters = 
        [ ProvidedStaticParameter("Sample", typeof<string>)
          ...
          ProvidedStaticParameter("InferDictionariesFromRecords", typeof<bool>, parameterDefaultValue = false) ]
    ...
    let helpText = 
        """<summary>Typed representation of a JSON document.</summary>
           ...
           <param name='InferDictionariesFromRecords'>If true, json record is considered as a dictionary, if the names of all the its fields are infered (by type inference rules) into the same non-string primitive type.</param>"""

...
<html lang="en">
  ...
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=pi3UZ6XjOOar5NoP44vm6AY" http-equiv="refresh" />
      <div style="display:block">
        Please click <a href="/httpservice/retry/enablejs?sei=pi3UZ6XjOOar5NoP44vm6AY">here</a> if you are not redirected within a few seconds.
      </div>
   ...*)
(**

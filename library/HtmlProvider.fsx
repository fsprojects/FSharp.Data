...
val stats: (string * decimal) array =
  [|("6.6", 3344M); ("6.5", 2032M); ("6.4", 403770M); ("6.3", 340664M);
    ("6.2", 141726M); ("6.1", 3098M); ("6.0", 18006M); ("5.0", 460693M);
    ("4.2", 891691M); ("4.1", 199135M); ("4.0", 120793M); ("3.3", 1255486M);
    ("3.2", 64155M); ("3.1", 262678M); ("3.0", 643511M); ("2.4", 486426M);
    ("2.3", 640313M); ("2.2", 374163M); ("2.1", 46021M); ("2.0", 168096M);
    ("1.1", 125984M); ("1.0", 78354M)|]*)
(**

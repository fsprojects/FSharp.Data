...
val stats: (string * decimal) array =
  [|("6.3", 120829M); ("6.2", 92559M); ("6.1", 2716M); ("6.0", 13990M);
    ("5.0", 347472M); ("4.2", 727192M); ("4.1", 173395M); ("4.0", 108031M);
    ("3.3", 1125748M); ("3.2", 49896M); ("3.1", 247980M); ("3.0", 560835M);
    ("2.4", 471146M); ("2.3", 596669M); ("2.2", 349013M); ("2.1", 42819M);
    ("2.0", 153331M); ("1.1", 115925M); ("1.0", 68968M)|]*)
(**

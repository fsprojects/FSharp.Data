...
val stats: (string * decimal) array =
  [|("6.4", 15426M); ("6.3", 145909M); ("6.2", 100168M); ("6.1", 2997M);
    ("6.0", 15137M); ("5.0", 366251M); ("4.2", 747302M); ("4.1", 176560M);
    ("4.0", 110114M); ("3.3", 1140445M); ("3.2", 51477M); ("3.1", 249350M);
    ("3.0", 570789M); ("2.4", 474643M); ("2.3", 606293M); ("2.2", 356663M);
    ("2.1", 44810M); ("2.0", 162098M); ("1.1", 119271M); ("1.0", 74838M)|]*)
(**

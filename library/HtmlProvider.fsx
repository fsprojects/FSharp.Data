...
val stats: (string * decimal) array =
  [|("6.5", 1503M); ("6.4", 393925M); ("6.3", 337143M); ("6.2", 141315M);
    ("6.1", 3094M); ("6.0", 17955M); ("5.0", 458694M); ("4.2", 886857M);
    ("4.1", 198746M); ("4.0", 120628M); ("3.3", 1252962M); ("3.2", 63974M);
    ("3.1", 262554M); ("3.0", 642781M); ("2.4", 486222M); ("2.3", 639479M);
    ("2.2", 373871M); ("2.1", 45974M); ("2.0", 167780M); ("1.1", 125839M);
    ("1.0", 78210M)|]*)
(**

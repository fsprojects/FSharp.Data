...
<html lang="en">
  <head>
    <title>Google Search</title><style>body{background-color:#fff}</style><script nonce="Q3RrYueXIitBymnLb-ovOg">window.google = window.google || {};window.google.c = window.google.c || {cap:0};</script>
  </head>
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=gny1admnLOKhiLMP7POmqAo" http-equiv="refresh" />
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=gny1admnLOKhiLMP7POmqAo");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=9be909eea5a29677&ie=UTF-8&emsg="+[34 chars]);

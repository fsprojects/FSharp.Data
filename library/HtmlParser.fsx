...
<html lang="en">
  <head>
    <title>Google Search</title><style>body{background-color:#fff}</style>
  </head>
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=RYTdZ7KlIpGrxc8P2ZW48A4" http-equiv="refresh" />
      <div style="display:block">
        Please click <a href="/httpservice/retry/enablejs?sei=RYTdZ7KlIpGrxc8P2ZW48A4">here</a> if you are not redirected within a few seconds.
      </div>
   ...*)
(**
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=RYTdZ7KlIpGrxc8P2ZW48A4");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=f0590359a1a22646&ie=UTF-8&emsg="+[34 chars]);

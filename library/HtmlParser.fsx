...
<html lang="en">
  <head>
    <title>Google Search</title><style>body{background-color:#fff}</style><script nonce="ULLie5kDuZSxRHElTUY_fw">window.google = window.google || {};window.google.c = window.google.c || {cap:0};</script>
  </head>
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=A9zcaf6LNK3l5NoP6JD20As" http-equiv="refresh" />
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=A9zcaf6LNK3l5NoP6JD20As");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=344f3e5e0d3315c7&ie=UTF-8&emsg="+[34 chars]);

...
val links: (string * string) list =
  [("Google", "/?sa=X&ved=0ahUKEwiijZXO5_GEAxVvKFkFHbxqA4cQOwgC");
   ("here",
    "/search?q=FSharp.Data&sca_esv=8154e9ae6af1589a&sca_upv=1&ie=U"+[38 chars]);
   ("Videos",
    "/search?q=FSharp.Data&sca_esv=8154e9ae6af1589a&sca_upv=1&ie=U"+[75 chars]);
   ("Images",
    "/search?q=FSharp.Data&sca_esv=8154e9ae6af1589a&sca_upv=1&ie=U"+[76 chars]);
   ("News",
    "/search?q=FSharp.Data&sca_esv=8154e9ae6af1589a&sca_upv=1&ie=U"+[75 chars]);
   ("Maps",
    "/url?q=http://maps.google.co.uk/maps%3Fq%3DFSharp.Data%26um%3"+[145 chars]);
   ("Shopping",
    "/url?q=/search%3Fq%3DFSharp.Data%26sca_esv%3D8154e9ae6af1589a"+[186 chars]);
   ("Books",
    "/search?q=FSharp.Data&sca_esv=8154e9ae6af1589a&sca_upv=1&ie=U"+[75 chars]);
...
val searchResults: (string * string) list =
  [("Maps",
   ...
   ("Shopping",
    "/search%3Fq%3DFSharp.Data%26sca_esv%3D8154e9ae6af1589a%26sca_"+[93 chars])]*)

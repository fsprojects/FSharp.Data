...
val results: HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="JnERiaqwXSJWs9uYL_2CGA">(function(){
...
val links: (string * string) list =
  [("Google", "/?sa=X&ved=0ahUKEwiT97PI4PiKAxWDlu4BHa2YMksQOwgC");
   ("here",
    "/search?q=FSharp.Data&sca_esv=797e2f942c2b7f51&ie=UTF-8&gbv=1"+[28 chars]);
   ("Images",
    "/search?q=FSharp.Data&sca_esv=797e2f942c2b7f51&ie=UTF-8&tbm=i"+[66 chars]);
   ("News",
    "/search?q=FSharp.Data&sca_esv=797e2f942c2b7f51&ie=UTF-8&tbm=n"+[65 chars]);
   ("Videos",
    "/search?q=FSharp.Data&sca_esv=797e2f942c2b7f51&ie=UTF-8&tbm=v"+[65 chars]);
   ("Maps",
    "/url?q=http://maps.google.co.uk/maps%3Fq%3DFSharp.Data%26um%3"+[145 chars]);
   ("Shopping",
    "/url?q=/search%3Fq%3DFSharp.Data%26sca_esv%3D797e2f942c2b7f51"+[172 chars]);
   ("Books",
    "/search?q=FSharp.Data&sca_esv=797e2f942c2b7f51&ie=UTF-8&tbm=b"+[65 chars]);
...
val searchResults: (string * string) list =
  [("Maps",
   ...
   ("Shopping",
    "/search%3Fq%3DFSharp.Data%26sca_esv%3D797e2f942c2b7f51%26ie%3"+[79 chars])]*)

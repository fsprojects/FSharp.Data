...
<html lang="en">
  ...
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=qC3UZ8nZIca05NoPncemuQM" http-equiv="refresh" />
      <div style="display:block">
        Please click <a href="/httpservice/retry/enablejs?sei=qC3UZ8nZIca05NoPncemuQM">here</a> if you are not redirected within a few seconds.
      </div>
   ...*)
(**
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=qC3UZ8nZIca05NoPncemuQM");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=fe99ce11bd8b5ba9&ie=UTF-8&emsg="+[34 chars]);

...
<html lang="en">
  <head>
    <title>Google Search</title><style>body{background-color:#fff}</style><script nonce="ci2dYKO80cbip0ZoVd9Nag">window.google = window.google || {};window.google.c = window.google.c || {cap:0};</script>
  </head>
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=YN2MapyJI9Kc0PEPgLuv6Qg" http-equiv="refresh" />
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=YN2MapyJI9Kc0PEPgLuv6Qg");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=0db7bc66a52a40c7&ie=UTF-8&emsg="+[34 chars]);

...
<html lang="en">
  <head>
    <title>Google Search</title><style>body{background-color:#fff}</style><script nonce="39lakJyiRausXdh4f5qQ-w">window.google = window.google || {};window.google.c = window.google.c || {cap:0};</script>
  </head>
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=BNzcadHcHaOe5NoPj97skAw" http-equiv="refresh" />
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=BNzcadHcHaOe5NoPj97skAw");
   ("click here",

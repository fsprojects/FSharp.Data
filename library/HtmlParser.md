...
<html lang="en">
  <head>
    <title>Google Search</title><style>body{background-color:#fff}</style><script nonce="MvikP-4i-RwjeMOiKATmnw">window.google = window.google || {};window.google.c = window.google.c || {cap:0};</script>
  </head>
  <body>
    <noscript>
      <style>table,div,span,p{display:none}</style><meta content="0;url=/httpservice/retry/enablejs?sei=bujpaYHdIKnQkPIPoY_cmAc" http-equiv="refresh" />
...
val links: (string * string) list =
  [("here", "/httpservice/retry/enablejs?sei=bujpaYHdIKnQkPIPoY_cmAc");
   ("click here",
    "/search?q=FSharp.Data&sca_esv=acde03bc46ff02b2&ie=UTF-8&emsg="+[34 chars]);
